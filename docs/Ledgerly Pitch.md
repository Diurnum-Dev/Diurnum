# Ledgerly
Ledgerly is an accounting app made for nerds. 

Built on the Beancount file format, Ledgerly is centered around text files. 
...
Ledgerly is an open-source product. Anyone can download it and use it for free. Available for MacOS, Linux, Windows, and eventually Android and iOS. 
...
## Main Screen
Ledgerly centers around the ledger, so the main screen displays your ledger by default. It's a text file, so it opens in a text editor. 
...
> Design a desktop app screen for **Ledgerly**, an accounting app for power users built on plain text files. This is the main **Ledger Editor** — the first thing users see when they open the app.
>
